...
public class TutorialManager : MonoBehaviour
{
    ...
    IEnumerator EndOfTutorial()
    {
        ...
        // Find and set up the buttons already present on the panel prefab in the scene
        var allButtons = tutorialCompletedPanel.GetComponentsInChildren<Button>(true);
        foreach (var b in allButtons)
        {
            if (b.name == "ModeButton_Rackup")
            {
                b.onClick.RemoveAllListeners();
                b.onClick.AddListener(() => EndTurotialWithMode(CubeSmasher.Mode.Rackup));
            }
            else if (b.name == "ModeButton_Clock")
            {
                b.onClick.RemoveAllListeners();
                b.onClick.AddListener(() => EndTurotialWithMode(CubeSmasher.Mode.Clock));
            }
            else if (b.name == "ModeButton_Classic")
            {
                b.onClick.RemoveAllListeners();
                b.onClick.AddListener(() => EndTurotialWithMode(CubeSmasher.Mode.Classic));
            }
            else if (b.name == "End it")
            {
